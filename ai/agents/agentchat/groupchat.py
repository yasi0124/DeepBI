    ...
    async def run_chat(
        ...
        for i in range(groupchat.max_round):
            ...
            for agent in groupchat.agents:
                if agent != speaker:
                    await self.send(message, agent, request_reply=False, silent=True)
            ...
            try:
                ...
                reply = await speaker.generate_reply(sender=self)
            ...
            await speaker.send(reply, self, request_reply=False)
